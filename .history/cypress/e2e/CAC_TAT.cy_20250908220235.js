describe("Central de Atendimento ao Cliente TAT", () => {
  ...
  it("exibe mensagem de erro ao submeter o formulário com um email com formatação inválida", () => {
    ...
    cy.get("#email")
    .as("fieldEmail")
    .type("everton.teste@.com");

    cy.get("#open-text-area")
    .as("feedbackField")
    .type(longText, { delay: 0 }); // com delay 0 o texto é preenchido de forma imediata, mesmo q seja grande
    cy.get("@feedbackField").should("have.value", longText);
  ...
  it.only('campo telefone continua vazio quando preenchido valor não numérico', () => {
    cy.get('#phone')
    .type('abcde')
    .should('have.text','')
