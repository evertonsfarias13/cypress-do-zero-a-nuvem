describe("Central de Atendimento ao Cliente TAT", () => {
  ...
  it('marca cada tipo de atendimento "feddback" ', () => {
    cy.get('input[type="radio"]') //ele vai pegar os 3 elementos radio
      .each((typeOfService) => {
        //transformar todos elementos em um array e passar por cada um
  ...
  it.only('seleciona um arquivo da pasta fixtures" ', () => {
    cy.get("#file-upload")
    .selectFile('C:\Users\evert\cypress-do-zero-nuvem\cypress-do-zero-a-nuvem\cypress\fixtures\example.json')
